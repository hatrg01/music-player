      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="albums.php"></a>
            </li>

            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-solid fa-compact-disc"></i> Albums</a>
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="add_album.php"><i class="fa-solid fa-circle-plus"></i> Add album</a></li>
                <li><a class="dropdown-item" href="edit_album.php"><i class="fa-solid fa-square-pen"></i> Edit album</a></li>
              </ul>
            </li>
          </ul>
